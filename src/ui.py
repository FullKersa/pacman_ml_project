...
person_income = st.number_input("Income", min_value=8000000)
...
loan_amnt = st.number_input("Loan Amount", min_value=1000000)
loan_int_rate = st.number_input("Interest Rate (%)", min_value=0.1, value=10.0)
loan_percent_income = st.number_input("Loan % of Income", min_value=0.1, value=0.2)
